...
const Media = () => {
  return (
    <>
      <section className="bg-[#E8EBF0] font-body xl:p-20 md:p-10  p-5 ">
        <div className="flex flex-col md:flex-row justify-evenly">
          <div className="">
            ...
            <div className="mx-auto mt-10 ">
              <h1 className="font-bold text-4xl xl:text-6xl font-body">
                Our goal is to <br /> provide inclusive <br /> care for children{" "}
                <br /> with special needs
              </h1>
              ...
              <button className="bg-[#096A56] my-5 py-3 px-5 rounded text-white mt-7">
                Read more
              </button>
            </div>
          </div>
          <div className="bg-white  rounded-2xl p-5 md:pr-16">
            
            <div className="flex flex-col items-center md:flex-row justify-between mb-3">
              <img src={autism} alt="" className="w-44 h-160" />
              <div className="ml-4">
                <h6 className="font-semibold mt-4">Austism care day</h6>
                <p className="font-semibold text-gray-400 text-xs my-2">
                15th Nov 2022
                </p>
                <p className="font-medium text-black ">
            ...
            <div className="flex flex-col items-center md:flex-row justify-between mb-3">
              <img src={down_syndrome} alt="" className="w-44 h-160" />
              <div className="ml-4">
                <h6 className="font-semibold mt-4">Down syndrome outreach</h6>
                <p className="font-semibold text-gray-400 text-xs my-2">
                  15th Nov 2022
                </p>
                <p className="font-medium text-black ">
